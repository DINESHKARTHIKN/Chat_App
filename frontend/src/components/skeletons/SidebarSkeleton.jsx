    ...
    <aside className="sidebar-skeleton">
      ...
      <div className="sidebar-skeleton-header">
        <div className="sidebar-skeleton-header-content">
          <Users className="sidebar-skeleton-header-icon" />
          <span className="sidebar-skeleton-header-text">Contacts</span>
        </div>
      </div>
      ...
      <div className="sidebar-skeleton-contacts">
        {skeletonContacts.map((_, idx) => (
          <div key={idx} className="sidebar-skeleton-contact">
            {/* Avatar skeleton */}
            <div className="sidebar-skeleton-avatar">
              <div className="sidebar-skeleton-avatar-img" />
            </div>

            {/* User info skeleton - only visible on larger screens */}
            <div className="sidebar-skeleton-info">
              <div className="sidebar-skeleton-name" />
              <div className="sidebar-skeleton-status" />
            </div>
          </div>
        ))}
      </div>
