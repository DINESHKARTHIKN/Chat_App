...
import SidebarSkeleton from "./skeletons/SidebarSkeleton";
import { Users } from "lucide-react";
import "./Sidebar.css"; // Make sure this import matches your file structure
    ...
    <aside className="sidebar-container">
      <div className="sidebar-header">
        <div className="sidebar-title">
          ...
          <span className="sidebar-heading">Contacts</span>
        </div>
        {/* TODO: Online filter toggle */}
        <div className="sidebar-filter">
          <label className="sidebar-checkbox">
            <input
              ...
              checked={showOnlineOnly}
              onChange={(e) => setShowOnlineOnly(e.target.checked)}
              className="sidebar-input-checkbox"
            />
            <span className="sidebar-checkbox-label">Show online only</span>
          </label>
        ...
        {filteredUsers.map((user) => (
          ...
          >
            <div className="sidebar-user-avatar-container">
              ...
              />
              {onlineUsers.includes(user._id) && (
                <span className="sidebar-user-online-status" />
              )}
            </div>
